...
INSERT INTO `Order` (warehouse_id, order_date, status, total_amount)
VALUES (1, NOW() - INTERVAL 10 DAY, 'Pending', 1500.50);

INSERT INTO `Order` (warehouse_id, order_date, status, total_amount)
VALUES (2, NOW() - INTERVAL 40 DAY, 'Approved', 3200.00);

INSERT INTO `Order` (warehouse_id, order_date, status, total_amount)
VALUES (1, NOW() - INTERVAL 5 DAY, 'Shipped', 780.75);

INSERT INTO `Order` (warehouse_id, order_date, status, total_amount)
VALUES (3, NOW() - INTERVAL 60 DAY, 'Delivered', 12500.99);
...
-- Remove discontinued product (only if no stock remains)
DELETE FROM Product
WHERE product_id = 4
  AND NOT EXISTS (
